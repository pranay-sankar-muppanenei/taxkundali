    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 px-6">
        ...
        <div className="flex flex-col gap-6">
          {/* Vision */}
          <div className="p-6 bg-red-50 rounded-2xl shadow-sm">
            <h3 className="inline-block bg-white text-red-700 font-bold text-lg px-4 py-2 rounded-xl mb-4">
              Our Vision
            </h3>
          ...
          {/* History */}
          <div className="p-6 bg-red-700 text-white rounded-2xl shadow-sm">
            <h3 className="inline-block  bg-white text-red-700 font-bold text-lg px-4 py-2 rounded-xl mb-4">
              Our History
            </h3>
            <p>
        ...
        <div className="relative rounded-2xl overflow-hidden shadow-lg">
          ...
          />
          <div className="absolute inset-0 bg-black/70 bg-opacity-60 flex flex-col justify-between  items-right text-right p-8">
            <div>
            ...
            <button className="px-6 py-3 bg-red-600 self-end text-white rounded-full hover:bg-red-700 transition">
              Contact Us
            </button>
          </div>
        </div>
